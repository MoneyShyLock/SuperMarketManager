				...
				<table class="box">
					...
					<tr>
						...
						<td><input type="text" name="user.age" class="text"
							id="age" /> <font color="red">*</font></td>
					</tr>
					<tr>
						<td class="field">用户电话：</td>
						<td><input type="text" name="user.phone" class="text"
							id="phone" /> <font color="red">*</font></td>

					</tr>
					<tr>
						<td class="field">用户权限：</td>

						<td><input type="radio" name="isadmin" id="auth"
							value="0" checked="checked" readonly="readonly"/>普通用户 <input type="radio"
							name="user.isadmin" id="auth" value="1"  readonly="readonly"/>经理</td>
					</tr>
				</table>
			</div>
			<div class="buttons">
